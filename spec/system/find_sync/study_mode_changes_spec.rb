...
RSpec.describe 'Sync from find' do
  ...
  def when_sync_provider_from_find_is_called
    FindSync::SyncProviderFromFind.call(provider_name: 'ABC College', provider_code: 'ABC', provider_recruitment_cycle_year: stubbed_recruitment_cycle_year, sync_courses: true)
  end
